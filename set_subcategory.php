...
{
	$cat_id = $_POST['cat_id'];
	$sel = "select * from product JOIN subcategory ON subcategory.sub_id = product.sub_id where subcategory.`cat_id` = '$cat_id' AND subcategory.`sub_status` = '1' AND product.`product_status` = '1'";
