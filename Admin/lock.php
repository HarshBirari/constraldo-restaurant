...
<body class="off-canvas-sidebar">
  ...
  <nav class="navbar navbar-expand-lg navbar-transparent navbar-absolute fixed-top text-white">
    <div class="container">
      <div class="navbar-wrapper">
        <a class="navbar-brand" href="javascript:;">Costraldo Restaurant</a>
      </div>
  ...
  <div class="wrapper wrapper-full-page">
    <div class="page-header lock-page header-filter" style="background-image: url('../asset/img/lock2.jpg')">
        ...
        <div class="row">
            ...
            <div class="card card-profile text-center card-hidden">
              <div class="card-header ">
                <div class="card-avatar">
                  <a href="#pablo">
                    <img class="img" src="image/<?php echo $fetch['image']; ?>">
                  </a>
                </div>
              </div>
              <?php if(isset($msg)) { ?>
          ...
          <?php } ?>
              ...
              <div class="card-footer justify-content-center">
                <button type="submit" name="submit" class="btn btn-rose btn-round">Unlock</button>
              </div>
            </div>
            </form>
          </div>
