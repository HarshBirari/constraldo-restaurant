<?php 
  ...
  {
    $ser = $_GET['search'];
    $sel = "select * from comfirm_order where `order_id` LIKE '%$ser%'";
    $sel1 = mysqli_query($con,$sel);
  }
  else
  {
    $sel = "select * from comfirm_order";
    $sel1 = mysqli_query($con,$sel);
  }
                    ...
                    <table id="datatables" class="table table-striped table-no-bordered table-hover" cellspacing="0" width="100%" style="width:100%">
                        ...
                        <?php } ?>
                          <td class="td-actions text-right">
                            ...
                            <a href="order_master.php?order_id=<?php echo $data['order_id']; ?>" rel="tooltip" class="btn btn-danger">
