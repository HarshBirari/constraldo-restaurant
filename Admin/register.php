...
if(isset($_POST['submit']))
{
  ...
  if($fname=="")
  {
    echo "<script>alert('Fisrt must be required!')</script>";
  }
  elseif($lname=="")
  {
    echo "<script>alert('Last must be required!')</script>";
  }
  elseif($email=="")
  {
  ...
  {
    echo "<script>alert('Contact no must be 10 digit!')</script>";
  }
  elseif($password=="")
  {
  ...
  elseif($gender=="")
  {
    echo "<script>alert('Gender must be checked!')</script>";
  }
  elseif($hobby=="")
  {
    echo "<script>alert('Hobby must be checked!')</script>";
  }
  elseif($country=="")
  {
    echo "<script>alert('Country must be checked!')</script>";
  }
  ...
  else
  {
    ...
    else
    {
      if($image=="")
      {
        echo "<script>alert('Image must be checked!')</script>";
      }
      else
      {
        $password = md5($_POST['password']);
        ...
        <div class="card ">
          ...
          <div class="card-body ">
            <form method="post" enctype="multipart/form-data" class="form-horizontal">
              ...
              <input type="hidden" name="password" value="<?php echo $que['password']; ?>">
              <div class="row">
